			...
			<div className="max-w-6xl mx-auto">
				...
				<div className="bg-white rounded-lg shadow-sm border border-[#E8F4F8] p-6 mb-6">
					...
					<div className="grid md:grid-cols-4 gap-4">
						...
						<Link
							href="/questions"
							className="bg-[#16A34A] text-white p-4 rounded-lg hover:bg-[#001242] transition-colors text-center"
						>
							<div className="text-2xl mb-2">📊</div>
						...
						<Link
							href="/vocab-test"
							className="bg-[#F59E0B] text-white p-4 rounded-lg hover:bg-[#D97706] transition-colors text-center"
						>
							<div className="text-2xl mb-2">📚</div>
							<div className="font-semibold">Vocab Test</div>
							<div className="text-sm opacity-90">
